...
"[project]/app/tools/sections/ToolComponent.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
_s(SkillCard, "QXSc2y/H4J+PADL8z7tze5vAlsk=", false, function() {
    return [
...
function ModernTechStack() {
    ...
    const filteredSkills = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "ModernTechStack.useMemo[filteredSkills]": ()=>{
            return SKILLS.filter({
                "ModernTechStack.useMemo[filteredSkills]": (s)=>(filter === "all" || s.category === filter) && s.name.toLowerCase().includes(search.toLowerCase())
            }["ModernTechStack.useMemo[filteredSkills]"]);
        }
    }["ModernTechStack.useMemo[filteredSkills]"], [
        filter,
...
_s1(ModernTechStack, "wk8ZdlkYXzciuoX0vSYEqG8GxqE=");
_c1 = ModernTechStack;
var _c, _c1;
__turbopack_context__.k.register(_c, "SkillCard");
__turbopack_context__.k.register(_c1, "ModernTechStack");
...
//# sourceMappingURL=_bddb47d5._.js.map